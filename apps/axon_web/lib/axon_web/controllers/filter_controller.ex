defmodule AxonWeb.FilterController do
  ...
  defp valid_room_id?(s) when is_binary(s), do: String.starts_with?(s, "!") and String.contains?(s, ":")
  defp valid_room_id?(_), do: false

  defp valid_user_id?(s) when is_binary(s), do: String.starts_with?(s, "@") and String.contains?(s, ":")
